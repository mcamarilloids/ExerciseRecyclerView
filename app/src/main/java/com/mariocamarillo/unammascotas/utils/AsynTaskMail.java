...
/**
 * Created by mario.camarillo on 16,octubre,2018
 */
public class AsynTaskMail extends AsyncTask<Void, Void, Void> {
    //Declaring Variables
    ...
    public AsynTaskMail(Context context, String email, String subject, String message) {
